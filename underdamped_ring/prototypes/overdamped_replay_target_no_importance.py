...
def train(position, steps, save_period, average_reward, force_parameters,
		  value_parameters, target_value_parameters, reward_learning_rate, replay_buffer):
	replay_index = 0
...
rewards = train(0, 100, 10, average_reward, force_parameters, value_parameters, 
				target_value_parameters, reward_learning_rate, replay_buffer)
initial_time = time.time()
rewards = train(0, training_steps, save_rate, average_reward, force_parameters, 
				target_value_parameters, value_parameters, reward_learning_rate, 
				replay_buffer)
print(time.time() - initial_time)
