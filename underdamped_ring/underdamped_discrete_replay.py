...
final_learning_rate = 10**(-5) / batch_size
...
def train(position, velocity, steps, save_period, average_reward, force_parameters,
	...
	for step in range(steps):
		...
		#for i in range(batch_size):
			...
			#print(td_errors[i])
		#print()
		errors = np.sum(td_errors)
		rounding = numba.int64(15)
		td_errors = np.round_(td_errors * importance_ratio, rounding, td_errors)
		#print(td_errors)
