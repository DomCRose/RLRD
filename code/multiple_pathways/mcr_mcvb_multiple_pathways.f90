...
!Computes optimal forces in potential with multiple reaction pathways, Gaussian basis, optionally uses a value baseline (mcr/mcvb)
...
!impose endpoint biasing
if (x2(1)>0 .and. pot<0) then !reached target region
    omega(2)=1 !indicator function is 1
end if

!Use quadratic cost for initialization
rval=-lam*(1.11-x2(1))**2-lam*(0.0-x2(2))**2
omega(4)=rval
